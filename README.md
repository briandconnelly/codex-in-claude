...
| `CODEX_IN_CLAUDE_MAX_OUTPUT_BYTES` | 10485760 | aggregate byte cap for a subprocess's captured stdout+stderr; output past it is dropped (head+tail kept), run not killed |
