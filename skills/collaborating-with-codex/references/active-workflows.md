...
including files not copied into the prompt — and it is not confined to it — read-only bounds
writes, not reads. For a high-reasoning-effort or broad repo-grounded consult
