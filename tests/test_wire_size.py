...
# ~600-byte summary each, the codex://params resource carrying the full contract): 96,787
# bytes (+2,657, +2.8%) — budget raised to the next 500 above the measured value. Spent
