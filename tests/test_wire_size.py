...
# ~600-byte summary each, the codex://params resource carrying the full contract): 96,855
# bytes (+2,725, +2.9%) — budget raised to the next 500 above the measured value. Spent
